  ...
  */
  ...
  public class Files {
    ...
    public static String getPath (String str) {
      ...
      List<String> parts = Arrays.explode (File.pathSeparator, str);
      ...
      if (Int.size (parts) > 1) {
        ...
        for (int i = 0; i < Int.size (parts) - 1; ++i) {
          ...
          if (i > 0) output.append (File.pathSeparator);
    ...
    public static String mksize (long bytes, String value, String sep, boolean si, int num, Locale locale) {
      return mksize (bytes, value, sep, si, num, locale, new String[] { "", "kb", "Mb", "Gb", "Tb" });
    }
      ...
      if (!value.equals ("")) {
        ...
        if (value.equals (lang[i]) || value.equals ("b")) {
          ...
          if (i > 0) {
            ...
            return String.valueOf (Int.numberFormat (bytes / pow, num));
            
          } else return String.valueOf (bytes);
        ...
        for (int i = 0; i < Int.size (lang); ++i) {
          ...
          if (bytes >= pow) {
            ...
            return format.format (bytes / pow) + sep + lang[i];
