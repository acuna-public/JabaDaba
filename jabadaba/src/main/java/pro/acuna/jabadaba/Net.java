	...
	*/
	...
	public class Net {
		...
		public static Map<String, Object> urlQueryDecode (String url) {
			...
			if (url != null) {
				...
				for (String key : keys) {
					...
					output.put (values[0], (Int.size (values) > 1 ? values[1] : ""));
		...
		public static InputStream getStream (String url) throws HttpRequestException {
			return getStream (url, getUserAgent ());
		}
		
		public static InputStream getStream (String url, String userAgent) throws HttpRequestException {
			return getStream (url, userAgent, "");
		}
		
		public static InputStream getStream (String url, String userAgent, String type) throws HttpRequestException {
		...
		public static List<String> getList (String url) throws HttpRequestException {
			return getList (url, getUserAgent ());
		}
		
		public static List<String> getList (String url, String userAgent) throws HttpRequestException {
    ...
    public static void download (String url, File fileName, String userAgent) throws HttpRequestException {
		...
		public static void download (String url, File fileName, String userAgent, ProgressListener listener, long length) throws HttpRequestException {
		...
		public static void download (String url, File fileName, String userAgent, ProgressListener listener, long length, int timeout) throws HttpRequestException {
