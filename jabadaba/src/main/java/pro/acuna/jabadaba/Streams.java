  ...
  */
  ...
  public class Streams {
    ...
    public static InputStream toInputStream (InputStream stream) throws IOException {
      return new BufferedInputStream (stream, Files.BUFFER_SIZE);
    }
    ...
    public static OutputStream toOutputStream (OutputStream stream) throws IOException {
