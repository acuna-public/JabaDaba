  ...
  */
  ...
  public class Arrays {
    ...
    public static String implode (String preg, JSONObject array) {
      
      StringBuilder output = new StringBuilder ();
      
      JSONArray items = array.names ();
    ...
    public static String implode (String preg, org.jsonp.JSONObject array) {
      
      StringBuilder output = new StringBuilder ();
      
      org.jsonp.JSONArray items = array.names ();
    ...
    public static String implode (String preg, JSONArray array) {
      ...
      for (int i = 0; i < Int.size (array); i++) {
        ...
        if (i > 0) output.append (preg);
        output.append (array.getString (i));
    ...
    public static String implode (String preg, org.jsonp.JSONArray array) {
    ...
    public static boolean contains (Object value, JSONArray arr) {
	  ...
	  public static boolean contains (Object value, org.jsonp.JSONArray arr) {
    ...
    public static Integer[] toIntArray (List<?> items) {
      ...
      for (int i = 0; i < Int.size (items); ++i)
        data[i] = Int.valueOf (items.get (i));
    ...
    public static Object endValue (List<?> array) {
    ...
    public static List<?> rsort (List<?> array) {
